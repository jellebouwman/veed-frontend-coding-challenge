...
describe('RepositoryLikeButton', () => {
  test('clicking the button should call the toggleLike function', () => {
    ...
    const { getByRole, rerender } = render(<RepositoryLikeButton isLiked={false} repositoryId={1} repositoryName={'my-repo'} toggleLike={toggleLike} />)
    ...
    rerender(<RepositoryLikeButton isLiked={true} repositoryId={1} repositoryName={'my-repo'} toggleLike={toggleLike} />)
